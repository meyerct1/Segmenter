...
%{
    im_name = cell(1,1)
    im_name{1} = ['20151029143827-11702-R02-C02' imExt];
    im_name{2} = ['20151029143827-11704-R02-C02' imExt];
    im_name{3} = ['20151029143827-11706-R02-C02' imExt];
    im_name{4} = ['20151029143827-11708-R02-C02' imExt];
