%function [] = MultiChannelSegmentation_v10()
...
cidrecorrect = 1;
tophat_rad = 50; %Tophat filter for non-cidre corrected images

%Image type im_type = 16 assume 16 bit image
...
%{
    im_name = cell(1,1)
    im_name{1} = ['20151210134031-9130-R02-C06' imExt];
    im_name{2} = ['20151210134031-9132-R02-C06' imExt];
    im_name{3} = ['20151210134031-9134-R02-C06' imExt];
    im_name{4} = ['20151210134031-9136-R02-C06' imExt];
    for i = 4:4
