...
% Last Modified by GUIDE v2.5 07-Jan-2016 16:14:53
...
handles.row = 'R02';
handles.col = 'C06';
%Size of disk applied both cytoplasmic and nuclear channel to filter out
...
handles.numLevels = str2double(get(findobj('Tag','edit11'),'String'));
...
handles.numLevels = get(hObject,'Value')
h = findobj('Tag','edit11')
set(h,'String',num2str(handles.numLevels))
guidata(hObject, handles);
...
handles.numLevel = str2num(get(hObject,'String'));
h = findobj('Tag','slider1');
set(h,'Value',handles.numLevel)
guidata(hObject,handles)
...
tempMat = [];
ImageParameter = [];
ImageParameter = {'Number_Flourescent_Channels_ex_Nuc','Segmentation_Level',...
    'Split_Nuclei','Noise_Filter','Segmentation_Smoothing_Factor','Cidre_correct_1_is_true',...
    'Segment_by_Nuclear_Dilation','Nuclear_Dilation_Factor','Segment_Cell_Surface',...
    'Cell_Surface_Dilation_Factor','Clear_Border_Cells'};
T = array2table([handles.numCh,handles.numLevels,handles.NucSegHeight,handles.noise_disk,...
