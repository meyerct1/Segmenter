...
ImageFolder= '~/Dropbox/Stain Images for Analysis/2013-03-07 MDA-MB-231 SCC 10X/1/';
OutputFolder='~/Dropbox/Stephen and Darren Shared/2013-03-07 MDA-MB-231 SCC 10X/';
CSVRepository = '~/Dropbox/Stephen and Darren Shared/Data Repository/2013-03-07 MDA-MB-231 SCC 10X/';
channels = 3; 
%
% User information for the output file
ExperimentDate = '20130307';
Time = '-1';
CellType = 'MDA-MB-231'; % A375 or skmel5
%
% THESE CAN BE ALTERED FOR BETTER SEGMENTATION; USER DISCRETION
Strel='disk';
StrelSize= 18; %15 
BrightnessThresholdPct=1.40; % 1.35
ClearBorder_intensity=false;
IntensityThresholdPct=0.1; % 0.1
MinObjectArea=200;
MaxObjectArea=800;
%
% % % % % % % % DO NOT ALTER % % % % % % % % % % % % 
