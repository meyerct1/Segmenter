...
InputFolder= '~/Dropbox/Stain Images for Analysis/skmel5 PLX4720 pRB Series/96hr/';
OutputFolder1='~/Dropbox/Stephen and Darren Shared/skmel5 PLX4720 pRB Series/96hr/';
...
%     three = (i * 3) +3;
    ...
    ImageName=[ImageFolder ImageNameStart num2str(ImageNameMiddle+one,NumberFormat) ImageNameEnd ImageExtension];
    ImageName2 = [ImageFolder ImageNameStart num2str(ImageNameMiddle+two,NumberFormat) ImageNameEnd ImageExtension];
    ImageName3 = [ImageFolder ImageNameStart num2str(ImageNameMiddle+three,NumberFormat) ImageNameEnd ImageExtension];;
