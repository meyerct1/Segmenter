...
cells_props=regionprops(FA_filter,'Centroid','Area');
...
valid_areas_idx= valid_areas_idx & ismember(cells_area, Object_Data(1:E,6));
valid_areas_idx= valid_areas_idx & ismember(cells_centroidX, Object_Data(1:E,4));
...
OutputImageFile= [OutputDirectory ImageRoot num2str(CurrentFrame) 'outimage' 'TESTB' ImageExtension];
