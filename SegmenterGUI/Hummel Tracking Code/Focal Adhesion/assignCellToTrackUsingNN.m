...
dist_to_existing_tracks=hypot(cur_tracks(:,centroid1Col)-cur_cell_centroid(1),cur_tracks(:,centroid2Col)-cur_cell_centroid(2));
...
if (isempty(track_idx))
    ...
    competing_dist=hypot(track_centroid(1)-competing_centroid(1),track_centroid(2)-competing_centroid(2));
